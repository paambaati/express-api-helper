...
describe('the api', function() {
    ...
    it('should respond with 400 status when POST request data is malformed', function(done) {
        var app = express(),
            expected = {
                message: 'Bad Request',
                errors: ['Missing required parameter: password']
            };
        app.use(bodyParser.json());
        app.use(bodyParser.urlencoded({
            extended: true
    ...
    it('should respond with 400 status when required request headers are missing', function(done) {
        var app = express(),
            expected = {
                message: 'Bad Request',
                errors: ['Missing required header parameter: X-Auth-Token']
            };
    ...
    it('should respond with 403 status when the client is forbidden', function(done) {
        var app = express(),
            expected = {
                message: 'Forbidden'
            };
